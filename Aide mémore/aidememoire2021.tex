...
Intégrer une fonction $f$ sur un intervalle $I$ c'est chercher toutes les primiteives de $f$ sur $I$.\\
Si $F$ est primitive de $f$ sur $I$, alors toute primitive de $f$ est de la forme $F(x)+c$, avec $c \in \mathbb{R}$. On convient d'écrire :\\
\begin{center}
